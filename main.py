# STABLE RELEASE. THIS IS VERISON A0.0.1
# Prompt user that this is version a0.0.1, incomplete.
input("This is version v0.0.1, which is incomplete.")
input("While TextFS Stable is incomplete and not released, check out Nightly!")
input("https://github.com/SoHiEarth/TextFS/tree/Nightly")
######################################################
